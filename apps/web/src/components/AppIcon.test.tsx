...
describe('AppIcon',()=>{
 it('renders every shared control icon as a decorative, non-focusable SVG',()=>{
  const names:AppIconName[]=['edit','copy','check','pin','close','plus','minus','chevronDown','chevronRight','locate','fit','details','canvas','play','activity','retry','clock','warning','settings','model','workflow','attachment','search'];
